...
def populate_data(db):
    ...
    add_recipe(db,'Eggs Benedict', 'img_eggs_benedict.jpg',
                  'Breakfast',
    ...
    add_recipe(db, 'Moi-moi', 'img_moimoi.jpg',
                    'Breakfast',
    ...
    add_recipe (db, 'Rice porridge with bread', 'img_riceporridge.jpg',
                    'Breakfast', 
    ...
    add_recipe (db,'Akara and pap', 'img_akara.jpg',
                    'Breakfast', 
    ...
    add_recipe (db,'Hausa kooko', 'img_hausa_koko.jpg',
                    'Breakfast',
    ...
    add_recipe(db, 'Fufu and light soup', 'img_fufu_soup.jpg',
                    'Lunch',
    ...
    add_recipe (db, 'Ugali', 'img_ugali.jpg',
                    'Lunch',
    ...
    add_recipe (db, 'BLT Sandwich', 'img_blt_sandwich.jpg',
                    'Lunch',
                    'Bacon, lettuce, tomato, mayonnaise, bread',
                    'Fry the bacon. Toast the bread. Assemble the sandwich.')
    
    add_recipe (db, 'Nyama Choma', 'img_nyamchom.jpg',
                    'Lunch', 
    ...
    add_recipe (db,'Eba and Egusi', 'img_ebagusi.jpg',
                    'Lunch', 
    ...
    add_recipe (db, 'Spaghetti Bolognese', 'img_spaghetti.jpg',
                    'Dinner',
    ...
    add_recipe (db, 'Bitter leaf soup', 'img_bitter_soup.jpg',
                    'Lunch',
    ...
    add_recipe (db, 'Jollof rice with plantain', 'img_jollof_rice.jpg',
                    'Dinner',
    ...
    add_recipe (db, 'Chocolate Cake','img_choc_cake.jpg',
                    'Dessert',
    ...
    add_recipe(db, 'Mandazi', 'img_mandazi.jpg',
                    'Dessert',
